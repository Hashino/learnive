...
const I18N = {
  en: {
    ...
    "manual.scanningHint": "the first scan extracts every PDF\u2019s text — the next ones are fast",
  ...
  "pt-BR": {
    ...
    "manual.scanningHint": "a primeira leitura extrai o texto de cada PDF — as seguintes são rápidas",
